...
diana.addqueendiacmd({ queeendiacmd: 'degis ?(.*)', fromMe: true, noinmenu: true, desc: Lang.DEGİS_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'restart$', fromMe: true, noinmenu: true, desc: Lang.RESTART_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'shutdown$', fromMe: true, noinmenu: true, desc: Lang.SHUTDOWN_DESC }, (async(message, match) => {
...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'dyno$', fromMe: true, noinmenu: true, desc: Lang.DYNO_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'dyno$', fromMe: false, noinmenu: true, desc: Lang.DYNO_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'setvar ?(.*)', fromMe: true, noinmenu: true, desc: Lang.SETVAR_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'delvar ?(.*)', fromMe: true, noinmenu: true, desc: Lang.DELVAR_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'getvar ?(.*)', fromMe: true, noinmenu: true, desc: Lang.GETVAR_DESC }, (async(message, match) => {
