...
diana.addqueendiacmd({ queeendiacmd: 'Nstopspam', fromMe: true, noinmenu: true, desc: Lang.STOP_SPAMDESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'Nsendspam ?(.*)', fromMe: true, noinmenu: true, desc: Lang.SPAM_DESC }, (async(message, match) => {
