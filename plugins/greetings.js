...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'welcome$', fromMe: true, desc: Lang.WELCOME_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmdiacmd: 'welcome (.*)', fromMe: true, noinmenu: true }, (async(message, match) => {
        if (match[1] === '') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'goodbye$', fromMe: true, desc: Lang.GOODBYE_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'goodbye (.*)', fromMe: true, noinmenu: true }, (async(message, match) => {
        if (match[1] === '') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'welcome (.*)', fromMe: true, noinmenu: true }, (async(message, match) => {
        if (match[1] === '') {
            return await message.client.sendMessage(message.jid, Lang.NEED_WELCOME_TEXT);
        } else {
            if (match[1] === 'delete') { await message.client.sendMessage(message.jid, Lang.WELCOME_DELETED, MessageType.text); return await sql.deleteMessage(message.jid, 'welcome'); }
...
if (Config.WORKTYPE == 'admin') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'welcome$', fromMe: false, desc: Lang.WELCOME_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'welcome (.*)', fromMe: false, noinmenu: true }, (async(message, match) => {
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (match[1] === '') {
            return await message.client.sendMessage(message.jid, Lang.NEED_WELCOME_TEXT);
    ...
    diana.addqueendiacmd({ queeendiacmd: 'goodbye$', fromMe: false, desc: Lang.GOODBYE_DESC }, (async(message, match) => {
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        var hg = await sql.getMessage(message.jid, 'goodbye');
        if (hg === false) {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'goodbye (.*)', fromMe: false, noinmenu: true }, (async(message, match) => {
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (match[1] === '') {
            return await message.client.sendMessage(message.jid, Lang.NEED_GOODBYE_TEXT, MessageType.text);
