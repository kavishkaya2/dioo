...
if (Config.WORKTYPE == 'admin') {
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'ban ?(.*)', fromMe: false, noinmenu: true, grponly: true, desc: Lang.BAN_DESC }, (async(message, match) => {
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'add(?: |$)(.*)', fromMe: false, noinmenu: true, grponly: true, desc: Lang.ADD_DESC }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'promote ?(.*)', fromMe: false, noinmenu: true, grponly: true, desc: Lang.PROMOTE_DESC }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'demote ?(.*)', fromMe: false, grponly: true, desc: Lang.DEMOTE_DESC, noinmenu: true }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'mute ?(.*)', fromMe: false, noinmenu: true, grponly: true, desc: Lang.MUTE_DESC }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'unmute ?(.*)', fromMe: false, noinmenu: true, grponly: true, desc: Lang.UNMUTE_DESC }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'invite ?(.*)', fromMe: false, noinmenu: true, grponly: true, desc: Lang.INVITE_DESC }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
        if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'rename ?(.*)', grponly: false, fromMe: true, desc: 'change group name' }, (async(message, match) => {
        var im = await checkImAdmin(message);
        var us = await checkUsAdmin(message);
        if (!us) return await message.client.sendMessage(message.jid, Lang.PLKADMIN, MessageType.text, { quoted: message.data });
