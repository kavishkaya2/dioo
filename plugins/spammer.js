...
diana.addqueendiacmd({ queeendiacmd: 'killspam', fromMe: true, noinmenu: true, desc: Lang.STOP_SPAMDESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'spam ?(.*)', fromMe: true, noinmenu: true, desc: Lang.SPAM_DESC }, (async(message, match) => {
