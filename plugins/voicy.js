...
if (conf.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'voicy', desc: Lang.USAGE, fromMe: true }, (async(message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'voicy', desc: Lang.USAGE, fromMe: false }, (async(message, match) => {
