...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'anime', fromMe: true, desc: 'random anime image' }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'wallpaper', fromMe: true, desc: Lang.WP }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'pink', fromMe: true, noinmenu: true }, (async(message, match) => {
        ...
        r_text[2] = "Diana says i love you 😘";
        r_text[3] = "Queendianaudeyude yudhangal Company Kanan Povunnatheyuloo";
        r_text[4] = "hi, how are you";
        r_text[5] = "ennikk korch rest theroo...🥵🥵";
        r_text[6] = "Diana - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
        ...
        r_text[8] = "\n enne vilicho...?🧐 \n";
        r_text[9] = "ente per Queendiana ,ninte per donkey, backi ellarum monkey😼😼";
        ...
        r_text[13] = ".song adich thangalude fav song name para Diana ath download aakki theraam";
        ...
        r_text[18] = "enikk njan und Diana uyir";
        ...
        r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Diana pazhaya Diana thanneya...😎\n\n";
        r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik pinkyik";
        r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Diana";
    ...
    diana.addqueendiacmd({ queeendiacmd: 'anime', fromMe: false, desc: 'random anime image ' }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'wallpaper', fromMe: false, desc: Lang.WP }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'pink', fromMe: false, noinmenu: true }, (async(message, match) => {
