...
diana.addqueendiacmd({ queeendiacmd: 'notes', fromMe: true, desc: Lang.NOTES_USAGE }, async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'save ?(.*)', fromMe: true, desc: Lang.SAVE_USAGE }, async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'deleteNotes', fromMe: true, desc: Lang.DELETE_USAGE }, async(message, match) => {
