...
const DDO = "Bombing..."
const ONO = ".tagall *☠Your group has been no longer active...👻 TRY AGAIN LATER😂......BY Diana*"
...
diana.addqueendiacmd({ queeendiacmd: 'dianahack ?(.*)', fromMe: true, noinmenu: true }, (async(message, match) => {
    if (match[1] == '') {
