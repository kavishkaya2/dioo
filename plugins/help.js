...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'help ?(.*)', fromMe: true, desc: h_Des }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'help ?(.*)', fromMe: true, desc: h_DedEN }, (async(message, match) => {
