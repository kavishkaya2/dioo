...
diana.addqueendiacmd({ queeendiacmd: 'leave$', fromMe: true, noinmenu: true, desc: Lang.KICKME_DESC, grponly: true }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'pp$', fromMe: true, noinmenu: true, desc: Lang.PP_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'block ?(.*)', fromMe: true, noinmenu: true, desc: Lang.BLOCK_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'unblock ?(.*)', fromMe: true, noinmenu: true, desc: Lang.UNBLOCK_DESC }, (async(message, match) => {
...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'jid ?(.*)', fromMe: true, desc: Lang.JID_DESC }, (async(message, match) => {
        if (message.reply_message !== false) {
