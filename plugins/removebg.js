...
if (Config.WORKTYPE == 'private') {
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'removebg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC }, (async(message, match) => {
        ...
        if (Config.RBG_API_KEY === false) return await message.client.sendMessage(message.jid, Lang.NO_API_KEY.replace('remove.bg', 'https://github.com/phaticusthiccy/WhatsDianaDuplicated/wiki/Remove-BG-API-Key'), MessageType.text);
    ...
    Diana.addqueendiacmd({ queeendiacmd: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC }, (async(message, match) => {
