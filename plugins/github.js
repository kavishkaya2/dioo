...
if (Config.WORKTYPE == 'private') {
    ...
    tenu.addqueendiacmd({ queeendiacmd: 'github ?(.*)', fromMe: true, desc: Glang.GİTHUB_DESC }, async(message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    tenu.addqueendiacmd({ queeendiacmd: 'github ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async(message, match) => {
