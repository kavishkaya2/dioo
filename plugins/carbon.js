...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC }, (async(message, match) => {
