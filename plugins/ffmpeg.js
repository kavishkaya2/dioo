...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC }, (async(message, match) => {
