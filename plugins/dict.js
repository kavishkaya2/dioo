...
diana.addqueendiacmd({ queeendiacmd: 'lngcode', fromMe: false, noinmenu: true }, (async(message, match) => {
...
/*diana.addqueendiacmd({queeendiacmd: 'dict ?(.*)', fromMe: false,  noinmenu: true }, async (message, match) => {
...
/*diana.addqueendiacmd({ queeendiacmd: 'dict ?(.*)', fromMe: false, desc: "Use it as a dictionary.\nEg: .dict en_US;lead\n For supporting languages send *.lngcode*" }, async (message, match) => {
