...
if (Config.WORKTYPE == 'private') {
    diana.addqueendiacmd({ queeendiacmd: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC }, (async(message, match) => {
