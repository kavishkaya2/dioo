...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'ss ?(.*)', fromMe: true, desc: Lang.SS_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'ss ?(.*)', fromMe: false, desc: Lang.SS_DESC }, (async(message, match) => {
