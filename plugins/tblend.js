...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmddiacmd: 'tblend ?(.*)', fromMe: true, desc: Lang.T_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'tblend ?(.*)', fromMe: false, desc: Lang.T_DESC }, (async(message, match) => {
