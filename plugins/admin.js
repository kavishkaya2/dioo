...
diana.addqueendiacmd({ queeendiacmd: 'ban ?(.*)', fromMe: true, noinmenu: true, grponly: true, desc: Lang.BAN_DESC }, (async(message, match) => {
...
diana.addqueendiacmd({ queeendiacmd: 'add(?: |$)(.*)', fromMe: true, noinmenu: true, grponly: true, desc: Lang.ADD_DESC }, (async(message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
...
diana.addqueendiacmd({ queeendiacmd: 'promote ?(.*)', fromMe: true, noinmenu: true, grponly: true, desc: Lang.PROMOTE_DESC }, (async(message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
...
diana.addqueendiacmd({ queeendiacmd: 'demote ?(.*)', fromMe: true, grponly: true, desc: Lang.DEMOTE_DESC, noinmenu: true }, (async(message, match) => {
    var im = await checkImAdmin(message);
...
diana.addqueendiacmd({ queeendiacmd: 'mute ?(.*)', fromMe: true, noinmenu: true, grponly: true, desc: Lang.MUTE_DESC }, (async(message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
...
diana.addqueendiacmd({ queeendiacmd: 'unmute ?(.*)', fromMe: true, noinmenu: true, grponly: true, desc: Lang.UNMUTE_DESC }, (async(message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
...
diana.addqueendiacmd({ queeendiacmd: 'invite ?(.*)', fromMe: true, noinmenu: true, grponly: true, desc: Lang.INVITE_DESC }, (async(message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid, Lang.IM_NOT_ADMIN, MessageType.text);
