...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC }, (async(message, match) => {
