...
if (pb.WORKTYPE == 'private') {
    diana.addqueendiacmd({ queeendiacmd: '.', fromMe: true, noinmenu: true }, (async (message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: '.', fromMe: false, noinmenu: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
