...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'U ?(.*)', fromMe: true, desc: Lang.UV_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'unvoice', fromMe: true, desc: Lang.UV_DESC }, (async(message, match) => {
        if (message.reply_message === false);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
    ...
    diana.addqueendiacmd({ queeendiacmd: '2 ?(.*)', fromMe: true, noinmenu: true }, (async(message, match) => {
        if (message.reply_message === false);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
    ...
    diana.addqueendiacmd({ queeendiacmd: '1', fromMe: true, noinmenu: true }, (async(message, match) => {
        if (message.reply_message === false);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
    ...
    diana.addqueendiacmd({ queeendiacmd: 'unimage', fromMe: true, noinmenu: true }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'unvoice', fromMe: false, desc: Lang.UV_DESC }, (async(message, match) => {
        if (message.reply_message === false);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
