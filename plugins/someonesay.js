...
if (Config.WORKTYPE == 'private') {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'animesay ?(.*)', fromMe: true, desc: Lang.ANIME_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'changesay ?(.*)', fromMe: true, desc: Lang.CHANGE_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'trumpsay ?(.*)', fromMe: true, desc: Lang.TRUMP_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'animesay ?(.*)', fromMe: false, desc: Lang.ANIME_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'changesay ?(.*)', fromMe: false, desc: Lang.CHANGE_DESC }, (async(message, match) => {
    ...
    diana.addqueendiacmd({ queeendiacmd: 'trumpsay ?(.*)', fromMe: false, desc: Lang.TRUMP_DESC }, (async(message, match) => {
